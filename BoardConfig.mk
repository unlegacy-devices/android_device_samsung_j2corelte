...
# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := SRPRD18B008RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 21117472 # This is the maximum known partition size, but it can be higher, so we just omit it
